...
function array(dtype, content) {
  var _marked =
  /*#__PURE__*/
  _regenerator["default"].mark(shape);
  ...
  if ('object' == (0, _typeof2["default"])(content) && 'shape' in content && 'data' in content) {
    var _data = content.data;
    if (null != dtype && !(_data instanceof _dt.ARRAY_TYPES[dtype])) _data = _dt.ARRAY_TYPES[dtype].from(_data);
...
function (_Function) {
  ...
  (0, _createClass2["default"])(NDArray, [{
    ...
    value:
    /*#__PURE__*/
    _regenerator["default"].mark(function elems() {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _marked4 =
              /*#__PURE__*/
              _regenerator["default"].mark(elems);
