...
function shuffle(array) {
  var rand_int = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (from, until) {
  ...
  var until = arguments.length > 3 ? arguments[3] : undefined;

  if (WARN) {
    WARN = false;
    console.warn(new Error('arrays.shuffle is deprecated, use nd.rand.AleaRNG instead.'));
  }
