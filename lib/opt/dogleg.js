  ...
  return _regenerator["default"].wrap(function lsq_dogleg_gen$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _ref = _args.length > 2 && _args[2] !== undefined ? _args[2] : {}, _ref$r = _ref.r0, r0 = _ref$r === void 0 ? 1.1 : _ref$r, _ref$rMin = _ref.rMin, rMin = _ref$rMin === void 0 ? 0 : _ref$rMin, _ref$rMax = _ref.rMax, rMax = _ref$rMax === void 0 ? Infinity : _ref$rMax, _ref$shrinkLower = _ref.shrinkLower, shrinkLower = _ref$shrinkLower === void 0 ? 0.05 : _ref$shrinkLower, _ref$shrinkUpper = _ref.shrinkUpper, shrinkUpper = _ref$shrinkUpper === void 0 ? 0.95 : _ref$shrinkUpper, _ref$grow = _ref.grow, grow = _ref$grow === void 0 ? 1.4142135623730951 : _ref$grow, _ref$expectGainMin = _ref.expectGainMin, expectGainMin = _ref$expectGainMin === void 0 ? 0.25 : _ref$expectGainMin, _ref$expectGainMax = _ref.expectGainMax, expectGainMax = _ref$expectGainMax === void 0 ? 0.75 : _ref$expectGainMax, _ref$stuckLimit = _ref.stuckLimit, stuckLimit = _ref$stuckLimit === void 0 ? 32 : _ref$stuckLimit;
        ...
        case 8:
          ...
          throw new Error('lsq_dogleg_gen(fJ, x0, opt): opt.rMin must be non-negative.');
        ...
        case 28:
          ...
          throw new Error('lsq_dogleg_gen(fJ, x0, opt): opt.stuckLimit must be an integer.');
        ...
        case 31:
          ...
          throw new Error('lsq_dogleg_gen(fJ, x0, opt): opt.stuckLimit must not be negative.');
        ...
        case 72:
          if (solver.scaledNorm(dX) <= R * (1 + 1e-6)) {
            _context.next = 74;
            break;
          }

          throw new Error("Assertion failed: ".concat(solver.scaledNorm(dX), " <= ").concat(R, "."));
        ...
        case 93:
          ...
          R = Math.min(rMax * rScale(), Math.max((0, _float64_utils.nextUp)(R), R * grow)); // PREDICTION GREAT -> INCREASE TRUST RADIUS
