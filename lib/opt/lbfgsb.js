      ...
      switch (_context2.prev = _context2.next) {
        case 0:
          _ref = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : {}, _ref$historySize = _ref.historySize, historySize = _ref$historySize === void 0 ? 8 : _ref$historySize, _ref$lineSearch = _ref.lineSearch, lineSearch = _ref$lineSearch === void 0 ? (0, _more_thuente_u.more_thuente_u123)({
            fRed: 1e-3,
            gRed: 0.8
          }) : _ref$lineSearch, _ref$updateTol = _ref.updateTol, updateTol = _ref$updateTol === void 0 ? 1e-14 : _ref$updateTol;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 23:
                    ...
                    solver.forget(solver.m + 1 >>> 1); // if( solver.m === 0 )
                    //   solver.scale = 1024;
        ...
        case 43:
          return _context2.delegateYield(_loop(), "t0", 44);
