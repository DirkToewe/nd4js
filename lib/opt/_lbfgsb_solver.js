...
var LBFGSB_Solver = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(LBFGSB_Solver, [{
    ...
    key: "compute_be",
    value: function compute_be(j, hej) {
      var m = this.m,
          M = this.M,
          N = this.N,
          dG = this.dG,
      ...
      for (var _i12 = 1; _i12 < m; _i12++) {
        for (var _j10 = 0; _j10 < _i12; _j10++) {
          hej[m + _i12] += dXdG[M * _i12 + _j10] * hej[_j10] / dXdG[M * _j10 + _j10];
        }
      }
      ...
      for (var _i14 = 0; _i14 < m; _i14++) {
        hej[m + _i14] += dX[N * _i14 + j] * scale;
      }

      (0, _tri._tril_solve)(m, M, 1, J, 0, hej, m);
    }
  }, {
    key: "compute_ubbv",
    ...
    get: function get() {
      ...
      if (this._J_invalid) {
        ...
        for (var _i31 = 0; _i31 < m; _i31++) {
          for (var _j21 = 0; _j21 <= _i31; _j21++) {
            for (var k = 0; k < _j21; k++) {
              J[M * _i31 + _j21] += dXdG[M * _i31 + k] / dXdG[M * k + k] * dXdG[M * _j21 + k];
            }
          }
        }
