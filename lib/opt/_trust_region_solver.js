  ...
  (0, _createClass2["default"])(TrustRegionSolverLSQ, [{
    ...
    value: function computeMinRegularized(λ) {
      ...
      if (0 === λ && rnk < N) {
        ...
        for (var _i16 = 0; _i16 < rnk; _i16++) {
          Y[_i16] /= S[L * _i16 + _i16];

          for (var _j3 = _i16; ++_j3 < rnk;) {
            Y[_j3] -= S[L * _i16 + _j3] * Y[_i16];
          }
        }
      ...
      if (0 !== λ) {
        ...
        for (var _i20 = N; _i20-- > 0;) {
          ...
          var _j4 = (_i20 - rnk + N) % N;

          T[rnk * N + N * _j4 + _i20] = Dλ;
        } // COMPLETE QR DECOMPOSITION


        for (var _i21 = 0; _i21 < N; _i21++) {
          var J = Math.min(_i21 + 1, rnk) + N;
          ...
          for (var _j5 = N; _j5 < J; _j5++) {
            ...
            if (0 === s) continue;
            T[ii] = norm;
            (0, _giv_rot._giv_rot_rows)(T, N - 1 - _i21, ii + 1, ji + 1, c, s);
            (0, _giv_rot._giv_rot_rows)(Y, 1, _i21, _j5, c, s);
          }
        }
      ...
      for (var _i23 = N; _i23-- > 0;) {
        var _j6 = P[_i23];
        Y[_i23] = X[_j6] * D[_j6] * D[_j6];
      } // FORWARD SUBSTITUTION


      for (var _i24 = 0; _i24 < N; _i24++) {
        Y[_i24] /= T[N * _i24 + _i24];

        for (var _j7 = _i24; ++_j7 < N;) {
          Y[_j7] -= T[N * _i24 + _j7] * Y[_i24];
        }
      }
