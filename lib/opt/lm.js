  ...
  return _regenerator["default"].wrap(function lsq_lm_gen$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _ref = _args.length > 2 && _args[2] !== undefined ? _args[2] : {}, _ref$r = _ref.r0, r0 = _ref$r === void 0 ? 1.1 : _ref$r, _ref$rMin = _ref.rMin, rMin = _ref$rMin === void 0 ? 1e-8 : _ref$rMin, _ref$rMax = _ref.rMax, rMax = _ref$rMax === void 0 ? Infinity : _ref$rMax, _ref$rTol = _ref.rTol, rTol = _ref$rTol === void 0 ? 0.05 : _ref$rTol, _ref$lmLower = _ref.lmLower, lmLower = _ref$lmLower === void 0 ? 0.001 : _ref$lmLower, _ref$shrinkLower = _ref.shrinkLower, shrinkLower = _ref$shrinkLower === void 0 ? 0.1 : _ref$shrinkLower, _ref$shrinkUpper = _ref.shrinkUpper, shrinkUpper = _ref$shrinkUpper === void 0 ? 0.5 : _ref$shrinkUpper, _ref$grow = _ref.grow, grow = _ref$grow === void 0 ? 1.5 : _ref$grow, _ref$expectGainMin = _ref.expectGainMin, expectGainMin = _ref$expectGainMin === void 0 ? 0.25 : _ref$expectGainMin, _ref$expectGainMax = _ref.expectGainMax, expectGainMax = _ref$expectGainMax === void 0 ? 0.75 : _ref$expectGainMax;
        ...
        case 10:
          ...
          throw new Error('lsq_dogleg_gen(fJ, x0, opt): opt.rTol must be less than 1.');
        ...
        case 12:
          ...
          throw new Error('lsq_dogleg_gen(fJ, x0, opt): opt.rTol must be positive number.');
