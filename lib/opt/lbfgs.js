  ...
  return _regenerator["default"].wrap(function lsq_lbfgs_gen$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 28:
          _context2.next = 30;
          return [new _nd_array.NDArray(shape_x, x.data.slice()), new _nd_array.NDArray(shape_e, Float64Array.of(e)), new _nd_array.NDArray(shape_x, g.data.slice()), new _nd_array.NDArray(shape_f, f.data.slice()), new _nd_array.NDArray(shape_j, j.data.slice())];
