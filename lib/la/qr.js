    ...
    for (var i = 1; i < N; i++) {
      ...
      for (var j = 0; j < I; j++) {
        ...
        if (s !== 0) {
          ...
          (0, _giv_rot._giv_rot_rows)(Q, M - 1 - j, Q_off + M * j + (j + 1), Q_off + M * i + (j + 1), c, s);
          Q[jj] = norm;
        }
  ...
  function solv(d) {
    if (d === ndim - 2) {
      ...
      for (var _i5 = L; _i5-- > 0;) {
        for (var _j3 = J; _j3-- > 0;) {
          for (var _k = L; --_k > _i5;) {
            x_dat[x_off + _i5 * J + _j3] -= R_dat[R_off + I * _i5 + _k] * x_dat[x_off + _k * J + _j3];
          }

          x_dat[x_off + _i5 * J + _j3] /= R_dat[R_off + I * _i5 + _i5];
        }
      }
